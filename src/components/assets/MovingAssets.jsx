                ...
                <DialogContent>
                    <Box display="flex" gap={3} mb={2}>
                        ...
                        <Box>
                            ...
                            <Typography variant="subtitle2">Model: {detailAsset?.model}</Typography>
                            <Typography variant="subtitle2">Proizvođač: {detailAsset?.manufacturer}</Typography>
                            <Typography variant="subtitle2">Serijski broj: {detailAsset?.serialNumber}</Typography>
                            <Typography variant="subtitle2">Lokacija: {detailAsset?.location}</Typography>
                            <Typography variant="subtitle2">Dodeljeno: {detailAsset?.assignedTo}</Typography>
                            ...
                            <Typography variant="subtitle2">Garancija do: {detailAsset?.warranty}</Typography>
                        </Box>
                    </Box>
